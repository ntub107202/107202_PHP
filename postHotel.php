<?php
	...
	$sql="INSERT INTO 民宿資訊 (民宿名稱, 民宿地址市, 民宿地址區, 民宿地址路, 民宿電話, 民宿資訊, 民宿執照, 民宿圖片)
	VALUES
	('$_POST[row1]','$_POST[row2]','$_POST[row3]','$_POST[row4]','$_POST[row5]','$_POST[row6]','$_POST[row7]','$_POST[row8]')";
